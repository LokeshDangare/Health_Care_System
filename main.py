...
# Load datasets
sym_des = pd.read_csv("D:\Viit\Health_Care_System\datasets\symptoms_df.csv")
precautions = pd.read_csv("D:\Viit\Health_Care_System\datasets\precautions_df.csv")
workout = pd.read_csv("D:\Viit\Health_Care_System\datasets\workout_df.csv")
description = pd.read_csv("D:\Viit\Health_Care_System\datasets\description.csv")
medications = pd.read_csv("D:\Viit\Health_Care_System\datasets\medications.csv")
diets = pd.read_csv("D:\Viit\Health_Care_System\datasets\diets.csv")

# Load model
svc = pickle.load(open('D:\Viit\Health_Care_System\svc.pkl', 'rb'))
